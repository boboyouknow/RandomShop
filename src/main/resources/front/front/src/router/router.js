...
import zixunfankuiList from '../pages/zixunfankui/list'
import zixunfankuiDetail from '../pages/zixunfankui/detail'
import zixunfankuiAdd from '../pages/zixunfankui/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'zixunfankui',
					component: zixunfankuiList
				},
				{
					path: 'zixunfankuiDetail',
					component: zixunfankuiDetail
				},
				{
					path: 'zixunfankuiAdd',
					component: zixunfankuiAdd
				},
			]
		},
		{
