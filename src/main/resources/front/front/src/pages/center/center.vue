    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="商家编号" prop="shangjiabianhao">
            <el-input v-model="sessionForm.shangjiabianhao" placeholder="商家编号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="商家名称" prop="shangjiamingcheng">
            <el-input v-model="sessionForm.shangjiamingcheng" placeholder="商家名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="图片">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="shangjiatupianHandleAvatarSuccess">
              <img :style='{"border":"1px solid #e5d9c6","cursor":"pointer","color":"#333","borderRadius":"6px","textAlign":"center","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.tupian" :src="baseUrl + sessionForm.tupian" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="商家地址" prop="shangjiadizhi">
            <el-input v-model="sessionForm.shangjiadizhi" placeholder="商家地址" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="经营范围" prop="jingyingfanwei">
            <el-input v-model="sessionForm.jingyingfanwei" placeholder="经营范围" ></el-input>
          </el-form-item>
          <el-form-item class="balance" :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='shangjia'" label="余额">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
				<div @click="dialogFormVisibleMoney = true" :style='{"border":"1px solid #e5d9c6","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","color":"#e5d9c6","display":"inline-block","outline":"none","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}'>点我充值</div>
			</div>
		  </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="用户名" prop="yonghuming">
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="手机" prop="shouji">
  ...
  export default {
    ...
    created() {
      if ('shangjia' == this.userTableName) {
        this.$set(this.sessionForm, 'shangjiabianhao', null);
      }
      if ('shangjia' == this.userTableName) {
      ...
      if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'shangjiabianhao', [{ required: true, message: '请输入商家编号', trigger: 'blur' }]);
      }
      if ('shangjia' == this.userTableName) {
    ...
    methods: {
      ...
      shangjiatupianHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('shangjia' == this.userTableName) {
